		...
		<div class="video-publisher-flex-1 video-publisher-flex isset-video-stats-container" style="">
			<?php if ( $stats ) : ?>
				<div class="video-publisher-flex-1">
					...
					<div class="video-publisher-mt-2">
						<span class="video-publisher-bold"><?php _e( 'Logged in as', 'isset-video-publisher' ); ?>: </span>
						<span><?php echo $user['username']; ?>
							<a class="isset-video-a-icon" href="<?php echo $logout_url; ?>" title="<?php _e( 'Logout', 'isset-video-publisher' ); ?>">
								<span class="dashicons dashicons-migrate"></span>
							</a>
						</span>
					</div>
					<div>
						<span class="video-publisher-bold"><?php _e( 'Subscription type', 'isset-video-publisher' ); ?>: </span>
						<span>
			...
			<div class="video-publisher-flex-3">
				<div class="">
					<div class="video-publisher-mb-2 video-publisher-flex video-publisher-flex-end">
						<a href="#" id="videoPublisherChartToggleViews" class="isset-video-btn btn-primary"><?php _e( 'Views', 'isset-video-publisher' ); ?></a>
						<a href="#" id="videoPublisherChartToggleData" class="isset-video-btn btn-inactive video-publisher-ml-2"><?php _e( 'Data', 'isset-video-publisher' ); ?></a>
					</div>
